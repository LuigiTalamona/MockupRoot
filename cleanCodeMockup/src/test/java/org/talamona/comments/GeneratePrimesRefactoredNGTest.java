 ...
 * @author luigi
 */
public class GeneratePrimesRefactoredNGTest {

    public GeneratePrimesRefactoredNGTest() {
    }
    ...
    public void shouldBeGeneratePrimes(Integer maxValue, List expectedPrimes) {
        ...
        GeneratePrimesRefactored sut = new GeneratePrimesRefactored();


        int[] actualResults = sut.generatePrimes(maxValue);
