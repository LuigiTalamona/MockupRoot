...
public class OSxModemConfiguratorTest {
    ...
    public void testVisitHayesModem() {
        System.out.println("visit HayesModem for OSx Lion");
        h.accept(v);
        String configValue = h.getConfigurationValue();
        assertEquals(configValue, "&s1=8&D=3&M=1");
    }
    ...
    public void testVisitZoomModem() {
        System.out.println("visit ZoomModem for OSx Lion");
        z.accept(v);
        int configValue = z.getConfigurationValue();
        assertEquals(configValue, 52);
    }
    ...
    public void testVisitLuigiModem() {
        System.out.println("visit LuigiModem for OSx Lion");
        l.accept(v);
        String configValue = l.getConfigurationValue();
        assertEquals(configValue, "configuration for OSx Lion");
    }
}
